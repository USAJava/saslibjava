...
/**	Title:
    ASCII
Purpose:
    Render an image with ascii characters instead of pixels
Coders :
    Wil Cecil
Created:
    July 9, 2007, 5:35 PM
...
public class ASCII {
    ...
    /**
     *Takes Averages the Running Max of Sample and the next pos, only used in sample sizes more than 1x1
     */
     ...
     */
    private static final String fastASCII[] =
    {" ",".",":",",",";","8","B","#","M"};
    //{" ","'",".",",","!",":",";","-","v","z",
    // "o","+","a","Z","V","A","8","B","#","M",
    //};
...
888888888:::::8:::::::::M8888888MAmmmAMVMM888*88888888   88888888
    ...
    /**
     * This converts a 2 dim array [y][x] to a string
     * Sample Size 3 x 7 is pretty good
     */
