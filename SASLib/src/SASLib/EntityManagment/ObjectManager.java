...
public class ObjectManager {
     ...
     */
    private java.awt.Point calcGrid(double x, double y) {
    ...
    private java.util.HashSet<java.awt.Point> getGrids(Entity e) {
        Rectangle2D rect = e.getBoundingBox();
    ...
    /**
     * Adds the grid locs of Rectangle2D endpoint to a hashset
     * @param rect
     * @param grids
     */
    private void gridRectCalc(Rectangle2D rect, HashSet<java.awt.Point> grids) {
        //add all four points of Rectangle2D calculated as grid locs to the set
        grids.add(calcGrid(rect.getX(), rect.getY()));
        grids.add(calcGrid(rect.getX() + rect.getWidth(), rect.getY()));
        grids.add(calcGrid(rect.getX(), rect.getY() + rect.getHeight()));
        grids.add(calcGrid(rect.getX() + rect.getWidth(), rect.getY() + rect.getHeight()));
    }
     ...
     */
    public boolean updateEntity(Entity e, Rectangle2D oldBounds) {
    ...
    public void logic() {
        ...
        while (iter.hasNext()) {
            ...
            if (!checkCollisions(a, true)) {
                ...
                Rectangle2D rect = a.getBoundingBox();
