 ...
 * y = (CoSine(xScale * x - xShift) + yShift) / yScale
 * @author Wil Cecil
 */
public class CoSine implements SimpleFunction{
     ...
     * @param yScale
     */
    public CoSine( double xShift, double xScale, double yShift, double yScale){
        this.xScale = xScale;
        this.xShift = xShift;
        this.yScale = yScale;
        this.yShift = yShift;
    ...
    public Double evaluate(double dependent) {
        return (RotMath.CoSine(xScale * dependent - xShift) + yShift) / yScale;
    }
