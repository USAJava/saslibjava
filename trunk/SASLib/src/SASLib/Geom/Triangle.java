...
public class Triangle implements Shape, Cloneable{
    ...
    public Triangle(Point p1, Point p2, Point p3) {
        ...
        bound = new Rectangle2D.Double(p1.getX(), p1.getY(), 0 , 0);
    ...
    public void render(GL gl, double x, double y, double zoom) {
        ...
        //render bound Rectangle2D
        //Rectangle2DRender.render(bound, gl);

//        for (int i = 0; i < lines.length; i++) {
//                Rectangle2D boundline = lines[i].getBounds();
//                Rectangle2DRender.render(boundline, gl);
//        }
    }
    ...
    public void translate(double deltaX, double deltaY) {
        ...
        bound = new Rectangle2D.Double(
                lines[lines.length-1].pnt1.getX(), 
                lines[lines.length-1].pnt1.getY(), 0 , 0);
        for (int i = 0; i < lines.length; i++) {
            bound.add(lines[i].pnt1.getX(), lines[i].pnt1.getY());
        }
    }
