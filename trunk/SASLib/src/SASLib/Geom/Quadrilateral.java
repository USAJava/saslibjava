...
public class Quadrilateral implements Shape, Cloneable {
     ...
     * @param angle
     */
    public Quadrilateral(Rectangle2D rect, double angle) {
     ...
     * @param angle
     */
    public Quadrilateral(Rectangle2D rect, double angle, boolean aroundCenter) {
        points = new Point[4];
    ...
    private void generateBounds() {
        ...
        for (int i = 0; i < points.length; i++) {
            ...
            bounds.add(curr.getX(), curr.getY());
